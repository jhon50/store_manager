...
RSpec.describe StoresController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Store" do
        expect {
          post :create, params: {admin_store: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_store: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_store" do
        store = Store.create! valid_attributes
        put :update, params: {id: store.to_param, admin_store: new_attributes}, session: valid_session
        store.reload
      ...
      it "redirects to the admin_store" do
        store = Store.create! valid_attributes
        put :update, params: {id: store.to_param, admin_store: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        store = Store.create! valid_attributes
        put :update, params: {id: store.to_param, admin_store: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the admin_stores list" do
      store = Store.create! valid_attributes
      delete :destroy, params: {id: store.to_param}, session: valid_session
      expect(response).to redirect_to(admin_stores_url)
    end
  end
